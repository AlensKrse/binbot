...
public class PubSubConfig {
    ...
    @Value("${google.cloud.pub.sub.topic.name}")
    String topicName;

    @Value("${google.cloud.pub.sub.subscription.name}")
    ...
    public MessageHandler messageReceiver() {
        return message -> {
            ...
            Optional.ofNullable(originalMessage).ifPresent(BasicAcknowledgeablePubsubMessage::ack);
        };
    }
